 ...
 */
@WebServlet("/GradeAverageByType")
public class GradeAverageByType extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Student> gd = db.getGradeAverageByType(assignmentType,studentName);
	...
	private void printHtml(PrintWriter out, ArrayList<Student> gd){
		...
		out.println("<h2>Grade Average By Type</h2><br>");
		...
		for (Student g : gd){
			...
			out.println("<td>"+g.getStudentName()+"</td>");
			out.println("<td>"+g.getAverage()+"</td>");
