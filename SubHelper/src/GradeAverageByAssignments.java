 ...
 */
@WebServlet("/GradeAverageByAssignments")
public class GradeAverageByAssignments extends HttpServlet {
     ...
     */
    public GradeAverageByAssignments() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    //get data from form
	    String assignmentType = "homework";//request.getParameter("assignmentType");
		...
		ArrayList<Student> gd = db.getGradeAverageByAssignments(assignmentType);
	...
	private void printHtml(PrintWriter out, ArrayList<Student> gd){
		...
		out.println("<h2>Grade High & Low By Type</h2><br>");
		out.println("<table class=\"table table-striped\">");
		out.println("<thead>");
		out.println("<tr>");
		out.println("<th>Assignment Type</th>");
		out.println("<th>Lowest Grade</th>");
		out.println("<th>Highest Grade</th>");
		...
		for (Student g : gd){
			...
			out.println("<td>"+g.getLow_grade()+"</td>");
			out.println("<td>"+g.getMax_grade()+"</td>");
			out.println("</tr>");
		}
